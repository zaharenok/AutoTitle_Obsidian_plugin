...
- [x] 1. Create ContentProcessor utility class
...
- [x] 2. Create TitleManager service class
...
- [x] 3. Update replaceTitle method to prevent duplication
...
- [x] 4. Update insertTitleIntoContent method to prevent duplication
...
- [x] 5. Add duplicate title detection and cleanup
...
- [x] 6. Create MigrationService for fixing existing notes
...
- [x] 7. Add migration command to plugin
...
- [x] 8. Update auto-generation logic to prevent duplication
...
- [x] 9. Update modal-based title generation
...
- [x] 11. Update existing tests and add integration tests
...
- [x] 12. Add title length validation and truncation
  - Implement title length validation to prevent overly long titles
  - Add truncation logic for titles exceeding maximum length
  - Ensure truncated titles remain meaningful and readable
  - Add setting to configure maximum title length
  - Write tests for title length validation and truncation
  - _Requirements: 4.3_

- [x] 13. Add settings for duplication handling
